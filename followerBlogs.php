...
<title><?php echo $_SESSION["username"] ?>'s followed posts.</title>
<a href = "userProfileFollow.php?user=<?php echo $_SESSION["username"] ?>">
  ...
  <?php   
	...
	<div class="form-group">
		...
		<a class="btn btn-info" href ="welcome.php">Switch to Community Posts</a>
		<br><br>
            <?php   
				$previousID = "";
             ...
             ?> <?php if($previousID != $rows['blogid'] && (!empty($_GET['afol'][0])||(!empty($_GET['ownBlog'][0]) &&$_GET['ownBlog'][0] == $rows["created_by"]))):?>		
  <div class="card">
